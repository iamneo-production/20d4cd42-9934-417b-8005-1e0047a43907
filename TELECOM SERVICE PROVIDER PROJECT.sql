/* TELECOM_SERVICE_PROVIDER PROJECT QUERIES */

/* Retrieving all the data from the table telecom_customer*/
select * from TELECOM_CUSTOMER;

/* (1) Query to list the customer names who are using the product Digital Subscriber Line */ 
...
/* The "Gold segment" is provided in service segment field.So I do this query to get an output */
SELECT CUSTOMERID, "Customer Name"
FROM TELECOM_CUSTOMER
